    ...
    if (!$.formUtils.haltValidation && errorInputs.length > 0) {
      ...
      if (displayError) {
        ...
        if (conf.scrollToTopOnError) {
          $('.modal-scrollable').animate({scrollTop : 50},800);
         // $window.scrollTop($form.offset().top - 20); //aiman
        }
      }
  ...
  $.formUtils = {
    ...
    defaultConfig: function () {
      return {
        ...
        borderColorOnError: '#EC6461', // Border color of elements which value is invalid, empty string to not change border color
        errorMessageClass: 'form-error', // class name of div containing error messages when validation fails
        validationRuleAttribute: 'data-validation', // name of the attribute holding the validation rules
        validationErrorMsgAttribute: 'data-validation-error-msg', // define custom err msg inline with element
        errorMessagePosition: 'top', // Can be either "top" or "element" or "custom"
