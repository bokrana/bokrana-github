  ...
  var getModal = function() {
    ...
    fadeIn = function(elem, interval) {
      if (+elem.style.opacity < 1) {
        ...
        var last = +new Date();
        var tick = function() {
          elem.style.opacity = +elem.style.opacity + (new Date() - last) / 100; //aiman
          last = +new Date();
  ...
  sweetAlert = swal = function() {
    ...
    var onButtonEvent = function(event) {
      ...
      switch (e.type) {
        case ("mouseover"):
          if (targetedConfirm) {
            target.style.backgroundColor = colorLuminance(params.confirmButtonColor, -0.00); //aiman
          }
          break;
        case ("mouseout"):
          if (targetedConfirm) {
        ...
        case ("mousedown"):
          if (targetedConfirm) {
            target.style.backgroundColor = colorLuminance(params.confirmButtonColor, -0.0);//aiman
          }
          break;
        case ("mouseup"):
          if (targetedConfirm) {
